        ...
        products: [
          {
            ...
            category: "model-s",
            stockStatus: true,
            options: ["view-details", "best-sellers", "interior", "floor-mats"],
          },
          {
            itemImg: SRoofRack,
            ...
            category: "model-s",
            stockStatus: true,
            options: ["view-details", "best-sellers", "exterior"],
          },
          {
            ...
            category: "model-s",
            stockStatus: true,
            options: ["view-details", "best-sellers", "floor-mats"],
          },
          {
            itemImg: S3YLiner,
      ...
      },
      {
        ...
        products: [
          ...
          },
          {
            ...
            category: "model-3",
            stockStatus: true,
            options: ["view-details", "best-sellers", "interior"],
          },
          {
            itemImg: m3YTrays,
        ...
        products: [
          {
            ...
            category: "apparel",
            stockStatus: true,
            options: ["quick-add+", "select-size", "tees", "best-sellers"],
          },
          {
            itemImg: mensTee2,
            ...
            category: "apparel",
            stockStatus: true,
            options: ["quick-add+", "select-size", "best-sellers", "tees"],
          },
          {
            itemImg: mensTee3,
          ...
          },
          {
            ...
            category: "apparel",
            stockStatus: true,
            options: ["quick-add+", "select-size", "Joggers", "best-sellers"],
          },
        ],
      },
      {
        ...
        products: [
          ...
          },
          {
            ...
            category: "model-s",
            stockStatus: true,
            options: ["view-details", "best-sellers"],
          },
        ],
      },
      {
